...
public class C01_MavenIlkTest {
    public static void main(String[] args) {
     ...
     //  6- Sayfadaki tum basliklari yazdiralim
        ...
        aramaKutusu.sendKeys(new CharSequence[]{"Samsung headphones" + Keys.ENTER});
        ...
        Iterator var5 = basliklarWebElementListesi.iterator();

        while(var5.hasNext()) {
            WebElement each = (WebElement)var5.next();
